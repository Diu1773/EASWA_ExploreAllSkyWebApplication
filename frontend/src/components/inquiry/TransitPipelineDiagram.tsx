  ...
  return (
    <section className="transit-pipeline">
      ...
      <p className="transit-pipeline-intro">
        {ko
          ? '대부분은 플랫폼이 자동으로 처리합니다. 여러분이 직접 판단하는 건 비교성·구경 같은 설정과 마지막 해석이에요. 각 단계가 왜 필요한지 먼저 보고 시작하세요.'
          : 'The platform handles most steps automatically. What you decide is the settings (comparisons, aperture) and the final interpretation. See why each step matters before you start.'}
      </p>
