...
function createEASWAPreserviceForm() {
  ...
  // 관련 긍정 진술을 별도로 확인한다. Q15의 1·2점은 어려움 진술에 대한 반대다.
  // 1차 Q15는 8명 긍정·1명 중립·3명 부정이며, 상대 최저점 자체가 실패의 근거는 아니다.
  // 방향의 일치 여부를 기술한다. 불일치만으로 역문항 효과나 1차 응답의 원인을 확정하지 않는다.
  ...
  form.addGridItem()
    ...
    .setHelpText('각 행마다 본인의 경험에 가장 가까운 것을 하나 선택해 주세요. 보거나 수행하지 않은 내용은 마지막 선택지를 골라 주세요.')
    .setRows([
      '용어·기호·단위의 뜻 이해',
      '그래프의 축·점·빈 구간 읽기',
      '각 단계의 할 일과 생각해보기 문항 찾기',
      '내 자료·분석 조건을 근거로 차이 설명하기'
    ])
    .setColumns([
      '화면만 보고 할 수 있었다',
      '진행자·다른 사람의 도움을 받아 할 수 있었다',
      '도움을 받아도 어려웠다',
      '어려웠지만 도움을 받지 못했다',
      '해당 내용을 보거나 수행하지 않았다'
    ])
