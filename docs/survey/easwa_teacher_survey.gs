...
function createEASWAForm() {
  ...
  form.addCheckboxItem()
    ...
    .showOtherOption(true)
    // 필수 아님: 문항 3에서 '경험 없음'을 고른 응답자에게 활용 이유를 강요하면
    // 만족화(아무거나 체크)로 데이터가 오염된다. 동기 문항은 '응답자 수 자체'가
    // 활용 요구의 근거이므로, 의향 있는 사람만 답하게 두는 편이 표본이 깨끗하다.
    // (survey-pilot-test 2026-07-20: 예비교사·천문전공 페르소나가 여기서 막힘)
    .setRequired(false);
