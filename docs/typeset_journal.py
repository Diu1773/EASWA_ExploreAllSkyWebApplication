...
@media print{
  ...
  /* ── 표지: 첫 쪽 전체를 쓰고 1단 ─────────────────────────── */
  .cover{column-span:all;break-after:page;text-align:center}
  .cover .kind{text-align:left;font-size:9pt;font-weight:700;margin:0 0 14mm}
  .cover .doctitle{font-size:19pt;line-height:1.35;font-weight:700;
                   margin:0 0 9mm;text-indent:0;border:0;text-align:center}
  .cover .au{font-size:11pt;margin:0 0 3mm;text-indent:0}
  .cover .af{font-size:9.5pt;margin:0 0 11mm;text-indent:0}
  .cover .entitle{font-family:"Times New Roman",serif;font-size:16pt;line-height:1.3;
  ...
  .cover .absbody p{font-size:8.6pt;line-height:1.6;text-align:justify;text-indent:0;
                    margin:0 0 .5em}
  .cover .kw{font-size:8.6pt;text-align:justify;text-indent:0;margin:4mm 0 0}
  .cover .corr{font-size:8.2pt;text-align:left;text-indent:0;margin:22mm 0 0;
  ...
  /* ── 표: 가로선만 ─────────────────────────────────────── */
  figure.tbl{margin:.8em 0 1em;break-inside:auto}
  figure.tbl.wide{column-span:all}
  figure.tbl.tall{column-span:all;break-before:page}
  .tcap{font-size:8.6pt;font-weight:700;margin-bottom:.3em;text-indent:0}
  table{font-size:8.3pt !important;line-height:1.42;border-collapse:collapse;width:100%}
  thead{display:table-header-group}
  tr{break-inside:avoid}
  th,td{border:0 !important;padding:3.2px 5px;vertical-align:top}
  thead th{border-top:1.1pt solid #000 !important;border-bottom:.4pt solid #000 !important;
           font-weight:700;white-space:normal;text-align:left}
  tbody tr:last-child td{border-bottom:1.1pt solid #000 !important}
...
def build_cover(s):
    ...
    cover = '<div class="cover"><p class="kind">| 연구논문 |</p>' + head + "</div>"
    return s[:i] + cover + s[j:]
