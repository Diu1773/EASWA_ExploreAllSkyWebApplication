...
rcParams["text.color"] = "#E8EAED"
rcParams["axes.labelcolor"] = "#E8EAED"
rcParams["xtick.color"] = "#C6CDD6"
rcParams["ytick.color"] = "#C6CDD6"
rcParams["figure.facecolor"] = "#0E1116"
rcParams["axes.facecolor"] = "#0E1116"
...
ax.spines["bottom"].set_color("#3A444F")
ax.grid(axis="x", color="#252D36", lw=0.8, zorder=0)
...
fig.text(0.012, 0.014, "* 부정 진술을 역채점한 값. 두 조사에서 모두 최하위 두 자리다. "
         ...
         fontsize=9.5, color="#98A1AD")
fig.tight_layout(rect=(0, 0.04, 1, 1))
fig.savefig("deck/fig_review_dark.png", facecolor="#0E1116")
print("저장 — deck/fig_review_dark.png")
