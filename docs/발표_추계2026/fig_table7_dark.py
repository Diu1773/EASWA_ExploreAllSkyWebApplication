...
NAVY, BLUE, GREY = "#F2A16B", "#E8752A", "#98A1AD"

fig, ax = plt.subplots(figsize=(8.8, 4.35), dpi=200)
x = range(5)

ax.axhspan(LIT - LITE, LIT + LITE, color="#5A6674", alpha=0.35, zorder=1)
ax.axhline(LIT, color=GREY, lw=1.4, zorder=2)
ax.text(4.42, LIT + 0.0011, "문헌값  Daylan et al. (2021)", color="#B8C0CA",
...
ax.spines["left"].set_color("#3A444F")
ax.spines["bottom"].set_color("#3A444F")
ax.grid(axis="y", color="#252D36", lw=0.8, zorder=0)
...
fig.savefig("deck/fig_table7_dark.png", facecolor="#0E1116")
print("저장 — deck/fig_table7_dark.png")
