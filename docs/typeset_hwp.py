...
/* ── 학회 템플릿 서식 (COM 실측) ── */
body{font-family:"KoPubWorld바탕체 Light","함초롬바탕","바탕",Batang,serif;font-size:10pt;line-height:1.6}
p,li,td,th{word-break:keep-all;line-break:strict}
h1.doctitle{font-family:"KoPubWorld바탕체_Pro Bold","함초롬바탕",serif;font-size:22pt;font-weight:700;
 text-align:center;line-height:1.35;border:0;margin:0 0 1.2em}
h1,h2,h3,h4{font-family:"KoPubWorld돋움체 Bold","함초롬돋움",sans-serif;font-weight:700}
h1{font-size:13pt}h2{font-size:11pt}h3{font-size:10.5pt}
table,.tcap,figure.fig figcaption{font-family:"KoPubWorld돋움체 Light","함초롬돋움",sans-serif;font-size:8.5pt}
.tcap{font-weight:700}
